...
public class MainApp {
    ...
    private static void ejecutarOpcion(Opcion opcion) {
        switch (opcion) {
            case SALIR:
                System.out.println("Gracias por utilizar el gestor de matriculas.");
                System.exit(0);
    ...
    private static void insertarAsignatura() {
        try {
            int nuevaAsignatura = Consola.leerAsignatura(Consola.leerCicloFormativo());
    ...
    private static void insertarMatricula() {
        try {
            Matricula nuevaMatricula = Consola.leerMatricula();
    ...
    private static void anularMatricula() {
        try {
            Matricula matriculaAEliminar = Consola.leerMatricula();
