...
public class Asignaturas {
    ...
    public void insertar(int asignatura) throws OperationNotSupportedException {
        ...
        coleccionAsignaturas[tamano] = new Asignatura(String.valueOf(asignatura));
        tamano++;
    }

    private boolean tamanoSuperado(int tamano) {
        return tamano >= getCapacidad();
    }
    ...
    public Asignatura buscar(Asignatura asignatura) {
        return coleccionAsignaturas[buscarIndice(asignatura)];
    }
